...
def augment_image(image, count=30):
    ...
    return augmented_images, augmented_images[0]  # Return the first augmented image
...
if uploaded_image is not None and class_name:
    ...
    augmented_images, example_image = augment_image(image)
    save_images(augmented_images, class_name)
 
    # Display one of the augmented images
    st.image(example_image, caption='Augmented Image', use_column_width=True)
